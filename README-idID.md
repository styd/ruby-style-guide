...
Panduan gaya penulisan kode ini berevolusi seiring waktunya dimana kesepakatan
...
<sup>[[link](#spaces-operators)]</sup>
  ...
  Ada beberapa pengecualian. Salah satunya adalah operator pemangkatan:
...
<sup>[[link](#consistent-multi-line-chains)]</sup>
  ...
  * **(Opsi A)** Jika melanjutkan _method_ berentet ke baris berikutnya,
    ...
    # baik - langsung jelas apa yang terjadi di baris kedua.
    one.two.three
      .four
    ```
...
<sup>[[link](#percent-q-shorthand)]</sup>
  ...
  ```ruby
  # buruk (no interpolation needed)
  %(<div class="text">Some text</div>)
  # should be '<div class="text">Some text</div>'

  # buruk (no double-quotes)
  %(This is #{quality} style)
  # should be "This is #{quality} style"

  # buruk (multiple lines)
  %(<div>\n<span class="big">#{exclamation}</span>\n</div>)
  # should be a heredoc.

  # baik (requires interpolation, has quotes, single line)
...
Berikut adalah beberapa _tools_ yang dapat membantu Anda mengecek kode Ruby berdasarkan
panduan ini.
...
and has baik Emacs integration.

### RubyMine

Inspeksi kode di [RubyMine](http://www.jetbrains.com/ruby/)
[sebagian dibuat berdasarkan](http://confluence.jetbrains.com/display/RUBYDEV/RubyMine+Inspections)
panduan ini.
...
[![Support via Gratipay](https://cdn.rawgit.com/gratipay/gratipay-burukge/2.3.0/dist/gratipay.png)](https://gratipay.com/~bbatsov/)

## Bagaimana Cara Berkontribusi?

Mudah. Cukup ikuti pedoman berikut: [contribution guidelines](https://github.com/bbatsov/ruby-style-guide/blob/master/CONTRIBUTING.md).

# Lisensi

![Creative Commons License](http://i.creativecommons.org/l/by/3.0/88x31.png)
Buah karya ini dilisensikan di bawah [Creative Commons Attribution 3.0 Unported License](http://creativecommons.org/licenses/by/3.0/deed.en_US)

# Sebarkan Pesan Ini

Panduan Gaya Penulisan Kode yang digerakkan oleh komunitas tidak berarti apa-apa jika
komunitasnya tidak tahu akan keberadaannya. Buat _tweet_ tentang panduan ini,
bagikan ke teman dan kolega Anda. Setiap tanggapan, saran, atau pendapat yang kami
terima membuat panduan ini menjadi sedikit lebih baik. Kita ingin punya panduan yang
